/**
 * Ralph CLI - Default Agent Prompt
 *
 * This module contains the default prompt that is sent to the AI agent.
 * It can be overridden by providing a custom prompt file via the --prompt CLI option.
 */

/**
 * The default prompt content for the Ralph agent.
 * This prompt instructs the AI on how to work through tasks autonomously.
 */
export const DEFAULT_PROMPT = `# Ralph Agent Instructions
